                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                color: widget.isDarkMode ? Colors.white.withValues(alpha: 0.2) : ctaBlue.withValues(alpha: 0.3),
                                width: 2,
                              ),
                            ),
                            child: Icon(
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              color: widget.isDarkMode ? Colors.white.withValues(alpha: 0.1) : Colors.white,
                              border: Border.all(
                                color: widget.isDarkMode ? Colors.white.withValues(alpha: 0.2) : const Color(0xFFE5E7EB),
                              ),
